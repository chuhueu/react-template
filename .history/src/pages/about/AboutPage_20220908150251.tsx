   ...
   <>
      ...
      <img src={BG} alt="background" className="background-image-about"/>
          <Box>
             ...
             <Grid className='professional-teams' container >
                    <Grid item className='professional-teams-box' lg={4} sm={12}>
                    ...
                    <Grid className='professional-teams-box-center' item lg={4} sm={12} >
                        <Box className='professionalCenter-img'>
                    ...
                    <Grid className='professional-teams-box' item  lg={4} sm={12}>
                    <Box className='professionalCenter-img'>
