   ...
   <>
      ...
      <img src={BG} alt="background" className="background-image-about"/>
          <Box>
             ...
             <Grid className='professional-teams' container spacing={4}>
                    <Grid item className='professional-teams-box' lg={4} >
                    ...
                    <Grid className='professional-teams-box-center' item lg={4}  >
                        <Grid className='professionalCenter-img'>
                    ...
                    <Grid className='professional-teams-box' item  lg={4} >
                    <Box className='professionalCenter-img'>
