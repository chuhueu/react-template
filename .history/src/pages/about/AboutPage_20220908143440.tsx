      ...
      <img src={BG} alt="background" className="background-image-about"/>
          <Box>
             ...
             <Grid className='professional-teams' container >
                    <Grid item className='professional-teams-box'xs={12} >
                    ...
                    <Grid className='professional-teams-box-center' item xs={12} >
                        <Box className='professionalCenter-img'>
                    ...
                    <Grid className='professional-teams-box' item xs={12} >
                    <Box className='professionalCenter-img'>
