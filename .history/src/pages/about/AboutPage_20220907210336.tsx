  ...
  return (
   <>
       <Box component="section">
        ...
        <Box component="p" textAlign="left" lineHeight={"24px"} >Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam,<br/> purus sit amet luctus venenatis.</Box>
      </Box>
   </>
  )
}
