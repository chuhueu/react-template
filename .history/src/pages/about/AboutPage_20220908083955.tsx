  ...
  return (
   <>
      ...
      <img src={BG} alt="background" className="background-image-about"/>
          ...
          <Box component="section" >
        <Typography variant="subtitle2" mb={2} textAlign="center" marginTop="362px" marginBottom="87px">Professional Teams</Typography>
        <Typography variant="h3" mb={2} textAlign="center">The Professional expert</Typography>
        <Box component="p" textAlign="center">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam.</Box>
      </Box>
          </Box>
          </Box>
      </Box>
