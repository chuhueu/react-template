      ...
      <img src={BG} alt="background" className="background-image-about"/>
          <Box>
             ...
             <Grid className='professional-teams' container >
                    <Grid item className='professional-teams-box'  xs={4} spacing={2}>
                    ...
                    <Grid className='professional-teams-box-center' item   xs={4}>
                        <Box className='professionalCenter-img'>
                    ...
                    <Grid className='professional-teams-box' item   xs={4}>
                    <Box className='professionalCenter-img'>
