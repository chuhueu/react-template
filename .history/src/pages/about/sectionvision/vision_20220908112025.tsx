      ...
      <Box component="section">
        <Box className="landing-page" gap={2}>
          <Box>
            ...
            <Typography variant="subtitle1" mb={3}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Elit, quam suscipit purus donec amet. Egestas volutpat facilisi eu libero.<br/>
