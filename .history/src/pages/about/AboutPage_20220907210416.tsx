  ...
  return (
   <>
       <Box component="section">
        ...
        <Box component="p" textAlign="left" lineHeight={"24px"} fontWeight="400">Lorem ipsum dolor sit amet, consectetur adipiscing elit ut aliquam, purus sit amet luctus venenatis.</Box>
      </Box>
   </>
  )
}
