          ...
          <Box className="video" paddingTop="58px">
            <Box className="play-video">
              <Box className="play-video-icon">
                ...
                >
                  <path
                    d="M25.0667 13.0012C26.4 13.771 26.4 15.6955 25.0666 16.4653L3.56665 28.8783C2.23332 29.6481 0.566651 28.6859 0.566651 27.1463L0.566652 2.32022C0.566652 0.780617 2.23332 -0.181632 3.56665 0.588168L25.0667 13.0012Z"
                    fill="white"
                  />
                </svg>
              </Box>
      ...
      <Box component="section" marginTop={"-358px"}>
        ...
        <Box>
          ...
          <Grid className="professional-teams" container mb={1}>
            <Grid item className="professional-teams-box" lg={4} sm={4} xs={12}>
            ...
            <Grid className="professional-teams-box" item lg={4} sm={4} xs={12}>
              <Box className="professionalCenter-img">
