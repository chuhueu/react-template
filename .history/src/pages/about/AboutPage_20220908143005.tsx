      ...
      <img src={BG} alt="background" className="background-image-about"/>
          <Box>
             ...
             <Box className='professional-teams'>
                    <Grid container item className='professional-teams-box'xs={12} >
                    ...
                    <Grid className='professional-teams-box-center' container item xs={12} >
                        <Box className='professionalCenter-img'>
                    ...
                    <Grid className='professional-teams-box'container item xs={12} >
                    <Box className='professionalCenter-img'>
