  ...
  return(
    <>
      ...
      <img src={BackgroundMask} alt="background" className="background-mask"/>
        ...
        <Typography variant="subtitle2" mb={2} textAlign="center" paddingTop="164px" color={"#ABB4FF"}>Business Slogan</Typography>
         <Typography variant="h3" textAlign="center" color={"#FFFFFF"}
         >Best responsibility and service </Typography> 
         <Typography variant="h3" mb={2} textAlign="center" color={"#FFFFFF"}
         >for our customers </Typography>
